        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s12 m8">
                    ...
                    <div style="background-color:#282828 " class="card horizontal card-no-shadow m-b-60">
                        ...
                        <div class="card-stacked p-l-15">
                            <div class="">
                                <h5 style="color: aliceblue" class="">{{ $agent->name }}</h5>
                                <strong style="color: aliceblue">{{ $agent->email }}</strong>
                            </div>
                            <div class="">
                                <p style="color: aliceblue">{{ $agent->about }}</p>
                            </div>
                        </div>
                    </div>

                    <h5 style="color: aliceblue" class="uppercase">Property List of {{ $agent->name }}</h5>

                    {{-- AGENT PROPERTIES --}}
                    @foreach($properties as $property)

                        <div style="background-color:#282828 " class="card horizontal card-no-shadow border1">
                            ...
                            <div class="card-stacked">
                                <div class="p-20 property-content">
                                    <span style="color: aliceblue" class="card-title search-title" title="{{$property->title}}">
                                        <a style="color: aliceblue" href="{{ route('property.show',$property->slug) }}">{{ str_limit($property->title,25) }}</a>
                                    </span>
