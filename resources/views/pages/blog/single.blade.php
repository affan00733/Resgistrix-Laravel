                ...
                <div class="col s12 m8">
                    ...
                    <div style="background-color: #393C3F" class="card">
                        ...
                        <div class="card-content">
                            <span style="color: aliceblue" class="card-title" title="{{$post->title}}">{{ $post->title }}</span>
                    ...
                    <div class="card" id="comments">
                        ...
                        <div style="background-color: #393C3F;color: aliceblue" class="single-narebay p-15">
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="content">
                                            <div class="author-name">
                                                ...
                                                @auth
                                                    <span style="color: rgb(209, 200, 200)" class="right replay" data-commentid="{{ $comment->id }}">Replay</span>
                                                @endauth
